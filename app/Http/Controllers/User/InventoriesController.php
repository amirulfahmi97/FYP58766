...
class InventoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('User.inventorylists',compact('inventories'));
    }
    ...
    public function create()
    {
        ...
        return view('User.addinventory',compact('locations'));
    }
    ...
    public function show($serialNo)
    {
        ...
        $locations = Location::all();
        return view('User.editinventory',compact('inventories','locations'));
    }
