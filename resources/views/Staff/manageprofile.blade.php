                ...
                <div class="col-sm-6">
                  <ol class="float-sm-right">
                    <div class="btn-group mr-7">
                        <a class="btn btn-secondary btn-outline float-right" href="{{ route('staffdashboard') }}" role="button">Back</a>
                    </div>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
                    ...
                    <div class="col-md-7 mb-3">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body box-profile">
                                <div class="mb-3">
                                    <form method="POST" action="{{ route('profileee.update',auth()->user()->userID) }}">
                                        @method('PUT')
                                            @csrf
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <form method="POST" action="{{ route('profileee.store') }}">
                                            @csrf
