                ...
                <div class="col-sm-6">
                  <ol class="float-sm-right">
                    <div class="btn-group mr-7">
                        <a class="btn btn-secondary btn-outline float-right" href="{{ route('inventoriess.index') }}" role="button">Back</a>
                    </div>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
                    ...
                    <div class="card-body box-profile">
                        <div class="mb-3">
                                ...
                                <!-- The input code start-->
                                    <form method="POST" action="{{ route('inventoriess.update',$inventories->serialNo) }}" enctype="multipart/form-data">
                                            @method('PUT')
                                                @csrf
