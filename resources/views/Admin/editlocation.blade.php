                ...
                <div class="col-sm-6">
                  <ol class="float-sm-right">
                    <div class="btn-group mr-7">
                        <a class="btn btn-secondary btn-outline float-right" href="{{ route('locationss.index') }}" role="button">Back</a>
                    </div>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <!-- The input code start-->
                            <form method="POST" action="{{ route('locationss.update',$location->locationID) }}">
                                    @method('PUT')
                                        @csrf
