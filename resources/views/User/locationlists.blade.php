...
@section('content')
    ...
    <div class="container">
        ...
        <main role="main" >
            ...
            <!-- Search function -->
            <form action="/user/locations/search" method="POST" role="search">
                {{ csrf_field() }}
            ...
            <div class="btn-toolbar justify-content-between mb-3" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group mr-7">
                    <a class="btn btn-secondary btn-outline" href="{{ route('locations.create') }}" role="button">Add Location <i class="material-icons align-bottom">add_location</i></a>
                </div>
                <form action="{{ route('locations.export') }}">
                    <div class="btn-group mr-7">
              ...
              <!-- This will be taken out from locations table -->
