...
@section('content')
    ...
    <div class="container">
            ...
            <main role="main" >
                ...
                <!-- Search function -->
                <form action="/user/inventories/search" method="POST" role="search">
                    {{ csrf_field() }}
                ...
                <div class="btn-toolbar justify-content-between mb-3" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group mr-7">
                        <a class="btn btn-secondary btn-outline" href="{{ route('inventories.create') }}" role="button">Add Item<i class="material-icons align-bottom">create_new_folder</i></a>
                    </div>
                <form action="{{ route('inventories.export') }}">
                    <div class="btn-group mr-7">
                  ...
                  @if(count($inventories) > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('inventories.edit',$inventory->serialNo) }}">{{$inventory->serialNo}}</a>
                            </td>
                            <td>
                                {{$inventory->assetTag}}
                            </td>
                            ...
                            <td>
                            <form action="{{ route('inventories.destroy',$inventory->serialNo) }}" method="POST">
                                @method('DELETE')
                                @csrf
